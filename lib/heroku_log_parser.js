...
LogParser.prototype._rebindEvents = function(){

  var self = this

  this._heventCalls.events.on('newservice', function(data){
    self.emit('newservice', data)
  })
  this._heventCalls.events.on('statechangeservice', function(data){
    self.emit('statechangeservice', data)
  })
  this._heventCalls.events.on('newsource', function(data){
    self.emit('newsource', data)
  })
  this._heventCalls.events.on('updatesource', function(data){
    self.emit('updatesource', data)
  })
